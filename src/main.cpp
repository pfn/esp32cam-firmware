// taken from https://github.com/arkhipenko/esp32-cam-mjpeg-multiclient/blob/master/esp32_camera_mjpeg_multiclient.ino
/*
...
void setup()
{
  ...
  if (err) {
    Serial.print("Failed to initialize MDNS: ");
    Serial.println(err);
    ESP.restart();
  }

  mdns_hostname_set("esp32cam");
  mdns_instance_name_set("ESP32 MJPEG Camera");
  mdns_service_add(NULL, "_http", "_tcp", 80, NULL, 0);
  mdns_service_instance_name_set("_http", "_tcp", "MJPEG Streaming at /mjpeg/1");
